...
f=f';
%%
kernel_pars(1:3)=[6.53214170134490,2492.32231373555,557.062851401056];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 99.3966778933012, 'wav_kernel',kernel_pars)
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
