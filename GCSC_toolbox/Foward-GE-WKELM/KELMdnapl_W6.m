...
f=f';
%%
kernel_pars(1:3)=[21.8315311322073,2604.39433030469,1258.29239056386];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 1802.85771944695, 'wav_kernel',kernel_pars)
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
