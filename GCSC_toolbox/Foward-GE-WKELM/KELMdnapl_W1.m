...
f=f';
%%
kernel_pars(1:3)=[63.3476973279624,3164.28348163615,535.533340469996];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 3549.93884837445, 'wav_kernel',kernel_pars)
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
