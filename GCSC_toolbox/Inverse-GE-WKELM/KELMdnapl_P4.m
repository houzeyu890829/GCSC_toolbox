...
f=f';
%%
kernel_pars(1:3)=[21.8775874935862,3643.02675852259,4432.26767874562];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 1090.25332600633, 'wav_kernel',kernel_pars)
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
