...
f=f';
%%
kernel_pars1(1:2)=[0.590740757904671,3.24372718464515];
kernel_pars2(1)=[5.13941064892443];
kernel_pars3(1:3)=[5.13941064892443,948.611973184704,0.00730156920258907];
%train
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY1] = elm_kernel('sinc_train', 'sinc_test', 0, 1.56486873522010, 'poly_kernel',kernel_pars);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY2] = elm_kernel('sinc_train', 'sinc_test', 0, 245.458938046066, 'RBF_kernel',kernel_pars);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY3] = elm_kernel('sinc_train', 'sinc_test', 0, 245.458938046066, 'wav_kernel',kernel_pars);
