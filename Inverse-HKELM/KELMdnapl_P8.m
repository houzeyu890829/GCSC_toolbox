...
f=f';
%%
kernel_pars1(1:2)=[1.64477532043384,5.80213683253935];
kernel_pars2(1)=[211.157507036850];
kernel_pars3(1:3)=[211.157507036850,1980.85164966737,1021.52901952055];
%train
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY1] = elm_kernel('sinc_train', 'sinc_test', 0, 0.302109131279860, 'poly_kernel',kernel_pars1);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY2] = elm_kernel('sinc_train', 'sinc_test', 0, 4999.99314546565, 'RBF_kernel',kernel_pars2);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY3] = elm_kernel('sinc_train', 'sinc_test', 0, 4999.99314546565, 'wav_kernel',kernel_pars3);
