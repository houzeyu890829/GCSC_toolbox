...
f=f';
%%
kernel_pars1(1:2)=[1728.29305315891,2.92256483204856];
kernel_pars2(1)=[0.247210271573373];
kernel_pars3(1:3)=[0.247210271573373,4044.40578950661,0.0196695333620767];
%train
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY1] = elm_kernel('sinc_train', 'sinc_test', 0, 16.4729868314560, 'poly_kernel',kernel_pars1);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY2] = elm_kernel('sinc_train', 'sinc_test', 0, 4991.07211801625, 'RBF_kernel',kernel_pars2);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY3] = elm_kernel('sinc_train', 'sinc_test', 0, 4991.07211801625, 'wav_kernel',kernel_pars3);
