...
f=f';
%%
kernel_pars1(1:2)=[0.142175559466349,6.62314792344415];
kernel_pars2(1)=[4771.67249338038];
kernel_pars3(1:3)=[4771.67249338038,7871.14320110658,6515.49111116889];
%train
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY1] = elm_kernel('sinc_train', 'sinc_test', 0, 9.99999910593030, 'poly_kernel',kernel_pars1);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY2] = elm_kernel('sinc_train', 'sinc_test', 0, 1047.21996328890, 'RBF_kernel',kernel_pars2);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY3] = elm_kernel('sinc_train', 'sinc_test', 0, 1047.21996328890, 'wav_kernel',kernel_pars3);
