...
f=f';
%%
kernel_pars1(1:2)=[27.9799112075541,2.72125013832003];
kernel_pars2(1)=[9.83074336739610];
kernel_pars3(1:3)=[9.83074336739610,1915.45715676120,365.073989780962];
%train
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY1] = elm_kernel('sinc_train', 'sinc_test', 0, 4866.89790686661, 'poly_kernel',kernel_pars1);
