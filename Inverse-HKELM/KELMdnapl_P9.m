...
f=f';
%%
kernel_pars1(1:2)=[12.9048738749288,5.32274560102062];
kernel_pars2(1)=[0.187009578556108];
kernel_pars3(1:3)=[0.187009578556108,1691.20853219058,676.288475879683];
%train
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY1] = elm_kernel('sinc_train', 'sinc_test', 0, 98.2446759416066, 'poly_kernel',kernel_pars1);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY2] = elm_kernel('sinc_train', 'sinc_test', 0, 341.067771347397, 'RBF_kernel',kernel_pars2);
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY3] = elm_kernel('sinc_train', 'sinc_test', 0, 341.067771347397, 'wav_kernel',kernel_pars3);
